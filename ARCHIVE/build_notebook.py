...
notebook = {
    "cells": [
        ...
        # CELL 6: Summary statistics (text output)
        {
            "cell_type": "code",
            "metadata": {},
            "source": [
                ...
                "\n",
                "print('📈 GREEKS (Risk Sensitivities)')\n",
                "print('-'*100)\n",
                ...
                "print('\\n(Greeks kept in backend — not shown in summary interface)')\n",
                "print('='*100)"
            ],
            "execution_count": None,
            "outputs": []
        },
        # CELL 7: The 4-visual summary
        {
            "cell_type": "code",
            "metadata": {},
            "source": [
                ...
                "ax.set_title('Why: Different Locations = Different Opportunities', fontweight='bold', fontsize=12)\n",
        ...
        # CELL 8: Summary text interpretation
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": [
...
print("✅ Notebook created: examples/FINAL_PRESENTATION.ipynb")
