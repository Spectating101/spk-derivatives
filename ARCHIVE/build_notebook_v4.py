...
notebook = {
    "cells": [
        ...
        # CELL 9: THE 4-VISUAL SUMMARY (REDESIGNED - DATA-DRIVEN ORDER)
        {
            "cell_type": "code",
            "metadata": {},
            "source": [
                ...
                "\n",
                "# ===== TOP RIGHT: Price Across Locations (WHY IT MATTERS) - SORTED BY ACTUAL DATA\n",
                "ax = axes[0, 1]\n",
                "loc_sorted = loc_df.sort_values('Binomial', ascending=True)\n",
                "colors = ['#6A994E', '#2E86AB', '#A23B72', '#F18F01', '#C73E1D']  # Green→Blue→Purple→Yellow→Red\n",
                ...
                "ax.set_title('WHY: Location Determines Hedge Cost (Based on NASA Data)', fontweight='bold', fontsize=13)\n",
                ...
                "\n",
                "# ===== BOTTOM RIGHT: Method Agreement (HOW SURE?) - SAME ORDER AS TOP RIGHT\n",
                "ax = axes[1, 1]\n",
        ...
        # CELL 10: Explanation of graphs
        {
            ...
            "source": [
                ...
                "---\n",
                "\n",
                "### TOP-RIGHT: Global Energy Pricing (Based on Real NASA Data)\n",
                "**What it shows**: Option prices for 5 global locations, ordered from cheapest (Germany) to most expensive (Brazil).\n",
                "\n",
                "**What it means**: \n",
                "- **Germany** ($0.0100/kWh): Cheapest to hedge. Northern European climate with specific solar patterns.\n",
                "- **Taiwan** ($0.0356/kWh): Our primary example. Typhoons and monsoons create high volatility.\n",
                "- **Saudi Arabia** ($0.0451/kWh): Despite abundant sun, energy costs more to hedge.\n",
                "- **Arizona** ($0.0463/kWh): Desert climate with seasonal variations.\n",
                "- **Brazil** ($0.0888/kWh): MOST EXPENSIVE—nearly 9x higher than Germany. Tropical weather patterns create complex energy variability.\n",
                "\n",
                "**What you say**: \"Location matters. Brazil is 9x more expensive to hedge than Germany because of different climate patterns. Where you mine/operate directly impacts your hedging costs.\"\n",
                "\n",
                "---\n",
                "\n",
                ...
                "\n",
                "**What it means**: Two completely independent mathematical methods give the same answer across ALL locations. If one was wrong, they'd disagree. But they don't—they agree everywhere.\n",
                "\n",
                "**What you say**: \"We used two completely different approaches. Both give the same answer in every location. That's how we know it's correct.\""
            ]
        },
...
print("✅ Notebook created with DATA-DRIVEN narrative: examples/FINAL_PRESENTATION.ipynb")
